...
- **[Student Services](services)** -- what students get access to
- **[Architecture](architecture)** -- how five LocoLabo projects converge here
- **[Proof of Concept](poc)** -- running today on two consumer GPUs
- **[Software Stack](stack)** -- every tool, every port, every integration
- **[Roadmap](roadmap)** -- from PoC to faculty-scale deployment
